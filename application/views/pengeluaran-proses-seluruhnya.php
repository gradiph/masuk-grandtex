...
<html lang="en">
	...
	<body class="">
		...
		<main class="py-5">
			<div class="container">
				<h1 class="text-center">Halaman Pengeluaran: Seluruhnya</h1>
				<section id="home">
                            ...
                            <tbody>
                                ...
                                foreach ($penerimaan as $p)
                                {
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="unit[]" class="form-control" value="<?php echo $p->unit; ?>" readonly></td>
                                        <td><input type="text" name="kilogram[]" class="form-control" value="<?php echo $p->kilogram; ?>" readonly></td>
                                        <td><input type="checkbox" name="id_penerimaan[]" value="<?php echo $p->id_penerimaan; ?>"></td>
                                    </tr>
                                    <?php
                                }
                                ?>
